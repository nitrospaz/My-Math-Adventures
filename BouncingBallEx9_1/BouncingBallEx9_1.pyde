...
class Ball:
    def __init__(self,x,y): #if you get an error "this constructor takes no arguments" check to see that you have two underscores and that you speled init correctly. lol.
        ...
        self.col = color(random(255),
                         random(255),
                         random(255))
        self.sz = random(5,55) #reference for random ball size
    ...
    def update(self):
        ...
        fill(self.col)
        #draw ball
        ellipse(self.xcor,self.ycor,self.sz,self.sz)#first 2 variables edit position, last 2 vairables edit size
